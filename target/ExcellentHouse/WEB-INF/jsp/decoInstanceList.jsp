...
<section id="property-listing">
    ...
    <header class="section-header text-center">
        <div class="container">
            <h2 class="pull-left">共有${totalNum}个装修案例，当前处于${page}/${totalPage}页</h2>
    ...
    <div class="container section-layout">
                    ...
                    <article class="property layout-item clearfix">
                        <figure class="feature-image">
                            <a class="clearfix zoom" href="single-property.html">
                                <img class="zoom"data-action="zoom" src="${instance.pictureList.get(0).pictureAddress}" alt="Property Image">
                            </a>
        ...
        <ul id="pagination" class="text-center clearfix">
            <c:choose>
                ...
                <c:otherwise>
                    <li><a href="/frontDecoInstance/list?page=${page - 1}">上一页</a></li>
                </c:otherwise>
            </c:choose>
            ...
            <c:forEach items="${pageList}" var="p">
                <c:choose>
                    <c:when test="${p == page}">
                        <li class="disabled"><a href="/frontDecoInstance/list?page=${p}">${p}</a></li>
                    </c:when>
                    <c:otherwise>
                        <li><a href="/frontDecoInstance/list?page=${p}">${p}</a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <li><a href="/frontDecoInstance/list?page=${page + 1}">下一页</a></li>
                </c:otherwise>
            </c:choose>
