...
public class Premises {
     ...
     * @mbggenerated Thu Sep 07 08:41:04 CST 2017
     */
    public Premises(Integer id, Integer companyId, String name, Integer location, String address, BigDecimal price, String phone, Date openingTime, Date createTime, Boolean isValid, Integer state, Integer serviceableYear, String saleAddress, Date deliverTime, String licenceNumber, Date licenceTime, String licenceInfo, Integer area, Integer parkingNumber, Float greeningRate, String introction, Integer type) {
        this.id = id;
