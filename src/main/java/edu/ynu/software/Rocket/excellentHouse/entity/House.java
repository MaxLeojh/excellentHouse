...
public class House {
     ...
     * @mbggenerated Thu Sep 07 08:40:44 CST 2017
     */
    public House(Integer id, Integer premisesId, Integer typeId, Integer userId, String name, Integer area, String decoration, Integer floor, String introduction, BigDecimal housePrice, Date createTime, Boolean isVaild) {
        this.id = id;
