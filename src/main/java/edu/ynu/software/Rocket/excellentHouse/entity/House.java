...
public class House {
     ...
     * @mbggenerated Mon Sep 25 20:11:08 CST 2017
     */
    public House(Integer id, Integer premisesId, Integer typeId, Integer userId, String kind, String name, Float area, String decoration, Integer floor, String introduction, BigDecimal housePrice, Date createTime, Boolean isVaild, Integer cityId, Float locationX, Float locationY, String contactName, String contactPhone, String type) {
        this.id = id;
