...
+"/nsso/ajax/checkUniqueField.do?jsoncallback=?",{mobile:$("#"+fieldId).val()},function(response){if(response.success==false){$("#"+errorId).html("<font color='red'>该手机已是会员,请在右侧登录</font>");$("#sso_mobileAndEmail").val(mobile);$("#"+fieldId).data("valid","false");return false;}else{$("#"+successId).html("<img src=http://login.lvmama.com/nsso/images/input_ok.gif>");$("#"+fieldId).data("valid","true");return true;}});$.ajaxSettings.async=true;}else{$("#"+errorId).html('<font color=\'red\'>请输入正确的手机号</font>');return false;}
return true;}
...
+"          </p>               "
+"          <p>              "
+"              <span class=\"inputValue\"><em class=\"contTsInfo\">我们会将您注册为会员，手机号为您的用户名，密码将通过免费短信发送到您手机。</em>   "
+"              </span>    "
+"          </p>       "
+"      </div>      "
+"      <div class=\"contRight\">     "
